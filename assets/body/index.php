...
=======
    <div class="container pt-5 pb-4" id="thereportshowr">
        <div id="taskholder">
            <div id="dropdown-div" class="m-0 p-0 mb-0 pb-0">
                <div class="dropdown"><button id="dropdown-btn" class="btn btn-primary p-0" aria-expanded="false" data-bs-toggle="dropdown" type="button"><svg class="bi bi-three-dots-vertical m-2" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
